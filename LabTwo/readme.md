...
- Repeat the experiments from (2) to (6) at least four more times. You will need to change the name of the data file everytime (e.g., *capture1.pcap*, *capture2.pcap*, ...). Make sure to show each of the capture in your report when you repeat the experiments. 
